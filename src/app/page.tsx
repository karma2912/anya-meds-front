      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            {showTwoFactor ? 'Enter the code from your authenticator app.' : 'Welcome back to your secure account.'}
          </p>
        </div>
            ...
            {!showTwoFactor ? (
                <>
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <Link href="/forgot-password" tabIndex={-1} className="text-xs font-medium text-blue-600 hover:underline">
                        Forgot Password?
                        </Link>
                    </div>
                    <div className="relative">
                ...
                <>
                    ...
                    <div className="grid w-full items-center gap-1.5">
                     ...
                     <Button variant="link" size="sm" className="text-blue-600" onClick={() => setShowTwoFactor(false)}>
                        Back to password
                    </Button>
                </>
            )}
