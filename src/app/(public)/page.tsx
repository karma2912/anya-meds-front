...
// Removed 'useRouter' from "next/navigation" as it's not available in this environment.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="md:hidden">
              <button
                // Using onTouchStart to eliminate the ~300ms click delay on mobile
                onTouchStart={() => setIsMenuOpen(!isMenuOpen)}
                // Increased size and padding for a larger, easier-to-hit touch target
                className="h-10 w-10 flex items-center justify-center rounded-full hover:bg-gray-100 active:bg-gray-200"
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="mt-4 flex justify-center">
                  <Button
                    ...
                    onClick={() =>
                      handleExternalNav("/find-a-doctor?specialty=primary-care")
                    }
                  >
                    View Doctors
                    <ChevronRight className="w-4 h-4 ml-2" />
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="mt-4 flex justify-center">
                  <Button
                    ...
                    onClick={() =>
                      handleExternalNav("/find-a-doctor?specialty=neurology")
                    }
                  >
                    View Specialists
                    <ChevronRight className="w-4 h-4 ml-2" />
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="mt-4 flex justify-center">
                  <Button
                    ...
                    onClick={() =>
                      handleExternalNav("/find-a-doctor?specialty=dermatology")
                    }
                  >
                    View Dermatologists
                    <ChevronRight className="w-4 h-4 ml-2" />
            ...
            <div className="mt-12 text-center">
              <Button
                ...
                onClick={() => handleExternalNav("/find-a-doctor")}
              >
